...
const styles = StyleSheet.create({
  panel: { padding: 16, borderRadius: 18, borderWidth: 1, borderColor: '#d7dfd2', backgroundColor: '#f7f8f2', gap: 14 },
  header: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', gap: 12 },
  title: { fontSize: 21, fontWeight: '900', color: '#203128' },
  subtitle: { maxWidth: 640, fontSize: 12, lineHeight: 18, color: '#58675f' },
  actions: { flexDirection: 'row', gap: 8, flexWrap: 'wrap' },
  filters: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', gap: 8 },
  input: { minWidth: 155, paddingHorizontal: 11, paddingVertical: 9, borderWidth: 1, borderColor: '#ced8cf', borderRadius: 10, backgroundColor: '#fff', fontSize: 12 },
  primaryButton: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 10, backgroundColor: '#245a39' },
  primaryText: { color: '#fff', fontSize: 11, fontWeight: '900' },
  secondaryButton: { paddingHorizontal: 13, paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: '#afbeaF', backgroundColor: '#f1f5ee' },
  secondaryText: { fontSize: 11, fontWeight: '900', color: '#2f533d' },
  content: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  listCard: { minWidth: 260, flexBasis: 290, flexGrow: 1, padding: 13, borderRadius: 14, borderWidth: 1, borderColor: '#d9e0d7', backgroundColor: '#fff', gap: 9 },
  reportCard: { minWidth: 320, flexBasis: 560, flexGrow: 2, padding: 14, borderRadius: 14, borderWidth: 1, borderColor: '#d9e0d7', backgroundColor: '#fff', gap: 12 },
  sectionTitle: { fontSize: 14, fontWeight: '900', color: '#24362d' },
  list: { gap: 8 },
  archiveRow: { padding: 10, borderRadius: 11, borderWidth: 1, borderColor: '#e2e8e0', backgroundColor: '#fbfcfa', gap: 4 },
  archiveRowActive: { borderColor: '#639168', backgroundColor: '#edf5e8' },
  reviewRow: { borderColor: '#e2b464', backgroundColor: '#fff5df' },
  separator: { height: 1, backgroundColor: '#edf1eb', marginVertical: 4 },
  rowBetween: { flexDirection: 'row', justifyContent: 'space-between', gap: 10, alignItems: 'center' },
  rowTitle: { fontSize: 12, fontWeight: '900', color: '#24362d' },
  ...
  reportStatus: { fontSize: 11, fontWeight: '900', color: '#195939', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999, backgroundColor: '#e1efe1' },
  meta: { fontSize: 11, lineHeight: 16, color: '#617269' },
  summaryGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  metric: { flexGrow: 1, minWidth: 130, padding: 10, borderRadius: 12, backgroundColor: '#e8f0e2' },
  metricWarning: { backgroundColor: '#fff1dc' },
  metricLabel: { fontSize: 10, fontWeight: '800', color: '#607168' },
  metricValue: { marginTop: 5, fontSize: 15, fontWeight: '900', color: '#203128' },
  section: { borderTopWidth: 1, borderTopColor: '#edf1eb', paddingTop: 10, gap: 6 },
